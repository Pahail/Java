...
public class WebPageWindow {
    ...
    public WebPageWindow(Boolean isLocal, String link, String name, int width, int height) {
        ...
        webStage.setX(Management.Control.getPrimaryStage().getX() + 270);
        webStage.setY(Management.Control.getPrimaryStage().getY() + 35);
        ...
        HBox.setMargin(closeButton, new Insets(5, 140, 5, 140));
